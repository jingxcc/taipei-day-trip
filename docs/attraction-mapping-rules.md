...
| **Replace** | A different attraction replaces the original attraction.    | Mark the original attraction as inactive, then insert the new attraction. Carry over the original attraction's `direction` and MRT relations when applicable. |
